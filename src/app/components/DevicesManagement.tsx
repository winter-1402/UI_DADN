  ...
  return (
    ...
    >
      ...
      {machine.status === "alert" && (
        <div className="h-0.5 w-full bg-gradient-to-r from-red-400 to-orange-400" />
      )}
      ...
      {/* Expandable Devices Section */}
      {machine.isOn && (
        <>
          <button
            onClick={() => setShowDetails(!showDetails)}
            className="w-full px-4 py-2 border-t border-slate-100 bg-slate-50 hover:bg-slate-100 transition-colors flex items-center justify-between"
          >
